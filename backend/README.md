...
## Project Structure
    ...
    ├── ideapros_llc_zoey_32948  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_zoey_32948`
...
2. Clone this repo and `cd ideapros_llc_zoey_32948`
